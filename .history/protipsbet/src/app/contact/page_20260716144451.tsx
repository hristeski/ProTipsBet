...
import { Mail, MessageSquare, Send, CheckCircle2, ShieldQuestion, Link } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-1 space-y-4">
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-6 flex flex-col items-center text-center">
            ...
            <p className="text-zinc-400 text-sm mb-4">Check our frequently asked questions for quick answers.</p>
            <a
              href="/#faq"
