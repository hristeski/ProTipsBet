...
export default function HistoryClient() {
  ...
  // Паметно филтрирање врз основа на насловот (description) или isVip статусот
  ...
  // Функција за одредување на бојата и текстот на значката
                  ...
                  <div className="p-5 border-b border-neutral-800 bg-neutral-900/50 flex justify-between items-start relative z-10">
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        <span className={`${badge.color} text-black px-2 py-0.5 rounded text-xs font-black uppercase flex items-center gap-1`}>
