...
export const ALL_BANNERS: BannerData[] = [
  ...
  { id: "22", href: "https://protipsbet.com/vip-tips", videoSrc: "/banners/protipsbet.mp4", imgSrc: "/banners/protipsbet.webp", alt: "ProTipsBet VIP Tips", width: 120, height: 40, position: "footer" },
