...
export const ALL_BANNERS: BannerData[] = [
  { id: "01", videoSrc: "/banners/prediction-banner-01.mp4", imgSrc: "/banners/prediction-banner-01.webp", alt: "Predictions for today", width: 200, height: 66 },
  { id: "02", videoSrc: "/banners/prediction-banner-02.mp4", imgSrc: "/banners/prediction-banner-02.webp", alt: "Sure win prediction today", width: 270, height: 70 },
