...
export const ALL_BANNERS: BannerData[] = [
  { id: "01", href: "https://www.soccervista.com", videoSrc: "/banners/prediction-banner-01.mp4", imgSrc: "/banners/prediction-banner-01.webp", alt: "Predictions for today", width: 96, height: 32 },
  { id: "02", href: "https://www.predictz.com", videoSrc: "/banners/prediction-banner-02.mp4", imgSrc: "/banners/prediction-banner-02.webp", alt: "Sure win prediction today", width: 96, height: 32 },
  { id: "03", href: "https://www.vitibet.com", videoSrc: "/banners/prediction-banner-03.mp4", imgSrc: "/banners/prediction-banner-03.webp", alt: "Vitibet predictions", width: 96, height: 32 },
