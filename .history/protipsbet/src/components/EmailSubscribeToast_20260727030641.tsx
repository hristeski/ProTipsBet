...
export default function EmailSubscribeToast() {
  ...
  return (
    // Позицијата е малку пониско од NotificationToast (top-40 наместо top-24) за да не се преклопуваат
    <div className="fixed top-[22%] md:top-40 left-1/2 -translate-x-1/2 z-50 w-[92%] max-w-sm">
