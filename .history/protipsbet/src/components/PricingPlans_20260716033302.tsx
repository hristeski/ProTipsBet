    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
      {PRICING_PLANS.map((plan) => (
        ...
        >
          {plan.badge && (
            <div
  className={`absolute -top-4 left-1/2 -translate-x-1/2 whitespace-nowrap text-xs font-black uppercase tracking-wider px-3 py-1.5 rounded-full flex items-center gap-1 shadow-lg ${
                plan.highlighted
